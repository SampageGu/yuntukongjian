...
import com.yunpicture.yunpicturebackend.api.aliyunai.AliYunAiApi;
import com.yunpicture.yunpicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
import com.yunpicture.yunpicturebackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
...
import com.yunpicture.yunpicturebackend.manage.FileManage;
import com.yunpicture.yunpicturebackend.manage.upload.FilePictureUpload;
import com.yunpicture.yunpicturebackend.manage.upload.PictureUploadTemplate;
import com.yunpicture.yunpicturebackend.manage.upload.UrlPictureUpload;
import com.yunpicture.yunpicturebackend.model.dto.file.UploadPictureResult;
import com.yunpicture.yunpicturebackend.model.dto.picture.*;
import com.yunpicture.yunpicturebackend.model.dto.picture.*;
...
import com.yunpicture.yunpicturebackend.model.enums.PictureReviewStatusEnum;
import com.yunpicture.yunpicturebackend.model.enums.SpaceRoleEnum;
import com.yunpicture.yunpicturebackend.model.vo.PictureVO;
import com.yunpicture.yunpicturebackend.model.vo.UserVO;
import com.yunpicture.yunpicturebackend.service.PictureService;
import com.yunpicture.yunpicturebackend.mapper.PictureMapper;
...
import com.yunpicture.yunpicturebackend.utils.ColorSimilarUtils;
...
//            更新空间使用额度
            boolean update = spaceService.lambdaUpdate()
                    ...
                    .setSql("totalCount=totalCount-1")
                    .update();
            ThrowUtils.throwIf(!update, ErrorCode.OPERATION_ERROR, "数据库额度更新失败");
            return true;
        });
