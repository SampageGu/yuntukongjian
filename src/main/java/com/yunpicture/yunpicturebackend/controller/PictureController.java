...
import com.yunpicture.yunpicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
...
import com.yunpicture.yunpicturebackend.manage.auth.StpKit;
import com.yunpicture.yunpicturebackend.manage.auth.annotation.SaSpaceCheckPermission;
import com.yunpicture.yunpicturebackend.manage.auth.model.SpaceUserPermissionConstant;
...
import com.yunpicture.yunpicturebackend.model.vo.PictureTagCategory;
...
//        空间权限校验
        ...
        if (spaceId != null) {
            ...
            ThrowUtils.throwIf(!permission, ErrorCode.NO_AUTH_ERROR, "无权限");
            //            User loginUser = userService.getLoginUser(request);
//            已经改为注解鉴权
